...
document.querySelectorAll("td a").forEach(function(sel) {
	...
	for (var i = 0; i < formats.length; i++) {
		if (fileExt.toLowerCase() == formats[i].toLowerCase()) {
			sel.innerHTML = '<img class="icons" src="https://dl.malwat.ch/theme/images/icons/' + formats[i] + '.png" style="margin:0px 4px -4px 0px"></img></a>' + oldText;
			found = 1;
	...
	if (sel.textContent.indexOf("Parent directory") >= 0) {
		sel.innerHTML = '<img class="icons" src="https://dl.malwat.ch/theme/images/icons/home.png" style="margin:0px 4px -4px 0px">' + oldText;
		found = 1;
	...
	if (sel.getAttribute("href").includes('/')) {
		...
		sel.innerHTML = '<img class="icons" src="https://dl.malwat.ch/theme/images/icons/folder.png" style="margin:0px 4px -4px 0px">' + oldText.substring(0, oldText.length - 1);
		found = 1;
	...
	if (found == 0) {
		sel.innerHTML = '<img class="icons" src="https://dl.malwat.ch/theme/images/icons/error.png" style="margin:0px 4px -4px 0px">' + oldText;
